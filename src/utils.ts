...
export function loadWalletKey(): Keypair {
    ...
    const loaded = Keypair.fromSecretKey(
        new Uint8Array([
            19, 50, 28, 200, 250, 27, 129, 153, 59, 243, 4, 225, 133, 17, 223, 24, 147, 112, 77, 72, 60, 210, 152,
            84, 6, 156, 138, 238, 20, 134, 40, 34, 28, 71, 248, 199, 198, 87, 146, 144, 1, 15, 71, 23, 86, 88, 245,
            212, 63, 69, 88, 3, 179, 119, 97, 217, 170, 168, 119, 90, 27, 5, 229, 110,
        ]),
    );
